 ...
 */
interface Http3RequestStreamEncodeState {
    /**
     * An implementation of {@link Http3RequestStreamEncodeState} that managed no state.
     */
    Http3RequestStreamEncodeState NO_ENCODE_STATE = new Http3RequestStreamEncodeState() {
        @Override
